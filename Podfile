...
pod 'UAFToolkit/Boilerplate', :path => '~/Xcode/Library/UAFToolkit'
pod 'UAFToolkit/Navigation',  :path => '~/Xcode/Library/UAFToolkit'
pod 'UAFToolkit/UI',          :path => '~/Xcode/Library/UAFToolkit'
